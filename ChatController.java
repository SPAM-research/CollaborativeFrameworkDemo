...
/**
 * This controller mimics the usage of the chat controller, it is created just
 * to do some experiments without the redis communication. IT should be deleted
 * afterwards
 * 
 * @author Pablo Arnau, Sergi Solera
 */
@Component
@RestController
...
public class ChatController {
    ...
    public String joinWaitroom(@PathVariable("wrapperId") Long wrapperId, Principal principal) {
        ...
        if (userInRoom.isPresent()) {
            ...
            waitroomService.setUserWaitRoom(user, wrapper);
        }
